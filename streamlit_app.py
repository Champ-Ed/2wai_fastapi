...
# Session configuration - now with configurable dataset and prompt file
session = {
    ...
    "dataset_name": st.secrets.get("DATASET_NAME", "calum_v10"),  # Configurable dataset
    "persona_prompt_path": st.secrets.get("PERSONA_PROMPT_FILE", "calum_prompt_v2.1.yaml"),  # Configurable prompt file
    "activeloop_org_id": st.secrets.get("ACTIVELOOP_ORG_ID", "")  # Pass organization ID for DeepLake
}
